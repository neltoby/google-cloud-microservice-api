...
const buildFindComments = require('./findComments');
...
describe('create comment', () => {
    ...
    beforeEach(async () => {
        ...
        findComment = buildFindComments({ commentDb, postDb })
    ...
    test('users can find comments for a post', async () => {
        ...
        const foundComment = await findComment({ ownerId: userId, postId: retVal.postId})
